...
|-----------|-------|
| **Nama Ubat** | Darunavir |
| **ID DrugBank** | [DB01264](https://go.drugbank.com/drugs/DB01264) |
| **Ramalan KG** | 2 |
| **Ramalan DL (≥0.7)** | 0 |
| **Tahap Bukti** | L5 |
...
- **MedicationKnowledge**: [`/fhir/MedicationKnowledge/DB01264`](/fhir/MedicationKnowledge/DB01264.json)
...
| Sumber | Pautan |
|----------|------|
| DrugBank | [View on DrugBank](https://go.drugbank.com/drugs/DB01264) |
| PubMed | [Search PubMed](https://pubmed.ncbi.nlm.nih.gov/?term=Darunavir) |
| ClinicalTrials.gov | [Search Trials](https://clinicaltrials.gov/search?intr=Darunavir) |
