...
Two active licenses are confirmed in the registry (total_licenses = 2, market_status = 已上市), but license number, product name, dosage form, and approved-indication text were not populated in this data pull.
