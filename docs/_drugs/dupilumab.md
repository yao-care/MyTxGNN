...
|-----------|-------|
| **Nama Ubat** | Dupilumab |
| **ID DrugBank** | [DB12159](https://go.drugbank.com/drugs/DB12159) |
| **Ramalan KG** | 4 |
| **Ramalan DL (≥0.7)** | 0 |
| **Tahap Bukti** | L5 |
...
- **MedicationKnowledge**: [`/fhir/MedicationKnowledge/DB12159`](/fhir/MedicationKnowledge/DB12159.json)
...
| Sumber | Pautan |
|----------|------|
| DrugBank | [View on DrugBank](https://go.drugbank.com/drugs/DB12159) |
| PubMed | [Search PubMed](https://pubmed.ncbi.nlm.nih.gov/?term=Dupilumab) |
| ClinicalTrials.gov | [Search Trials](https://clinicaltrials.gov/search?intr=Dupilumab) |
