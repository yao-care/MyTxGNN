...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from mytxgnn.collectors.drug_bundle import PredictedIndication
    from mytxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from mytxgnn.collectors.drug_bundle import DrugBundle
